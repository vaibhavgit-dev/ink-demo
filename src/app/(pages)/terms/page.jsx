...
function termsandcondition() {
  ...
  return (
    ...
    <div className="col-lg-9 order-lg-2 pb-20 ">
      <div className='container'>
        ...
        <h6  className="mt-4 w-full block"><strong>Content Usage:</strong></h6>
        ...
        <h6 className="mt-4 w-full block"><strong>Changes to Terms of Use:</strong></h6>
        ...
        <h6 className="mt-4 w-full block"><strong>Copyright and Ownership:</strong></h6>
        ...
        <ul className="list-disc px-5 pb-5"><li>None of the content may be downloaded, copied, reproduced, republished, posted, transmitted, stored, sold, or distributed without the prior written permission of the copyright holder, except for material specifically made available for ‘downloads’ and sharing on social media for personal, non-commercial home use only, provided that all copyright and proprietary notices are retained.</li>
          ...
          <h6 className="mt-4 w-full block"><strong>Site Access License:</strong></h6>
        ...
        <h6 className="mt-4 w-full block"><strong>Corporate Identification and Trademark:</strong></h6>
        ...
        <h6 className="mt-4 w-full block"><strong>Links to Third-Party Websites:</strong></h6>
        ...
        <h6 className="mt-4 w-full block"><strong>Fees:</strong></h6><p>For all charges for products and services sold on the Sites, BluOne Ink or its vendors will bill your credit card or alternative payment method. By providing credit card information, you represent that you are the authorized user of the card. Legal action may be taken to collect unpaid balances, and you agree to reimburse BluOne Ink for all expenses incurred.</p>
        <h6 className="mt-4 w-full block"><strong>Privacy Policy:</strong></h6><p>Data collection and use, including personal information, are governed by BluOne Ink’s Privacy Policy, which is incorporated into this Agreement.</p>    </div>
    </div>
    )}
    </> 
  )
